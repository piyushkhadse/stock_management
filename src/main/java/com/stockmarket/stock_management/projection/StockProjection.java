...
import com.stockmarket.stock_management.projection.repository.impl.StockProjectionRepositoryImpl;
...
public class StockProjection {
    ...
    @Autowired
    private StockProjectionRepositoryImpl stockProjectionRepository;
