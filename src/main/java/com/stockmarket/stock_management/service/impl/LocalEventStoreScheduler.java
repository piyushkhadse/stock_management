...
import com.stockmarket.stock_management.repository.impl.StockLocalEventRepositoryImpl;
...
public class LocalEventStoreScheduler {
    ...
    @Autowired
    private StockLocalEventRepositoryImpl stockLocalEventRepositoryImpl;
